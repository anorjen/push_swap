...
/*   Updated: 2020/11/24 11:21:26 by anorjen          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_list					**g_lst_operations;

/*
** arguments.c
*/
void					free_list(t_list *list);
void					finish(t_list **lst_operation, t_stack *stack_a,
															t_stack *stack_b);
...
int						run(t_list *lst_operation, t_stack **stack_a,
															t_stack **stack_b);
...
int						rotate_counter_b(int index, int prev_index,
																t_stack *stack);
